...
var _ConfiguredField = require('./ConfiguredField');
...
describe('Field', function() {
  it('mounts with standard attributes (control)', function() {
    ...
    var wrapper = (0, _enzyme.shallow)(
      _react.default.createElement(_ConfiguredField.RawConfiguredField, {
        type: type,
        data: data,
        classes: classes,
    ...
    (0, _chai.expect)(FC)
      ...
      .match(/rootClassName/)
      .not.match(/withLabelClass/); // no helpText, descriptionText or LabelComponent

    (0, _chai.expect)(FC.children()).to.have.length(2); // control
    // test Component properties

    var Component = wrapper.find(_Input.default); // control

    (0, _chai.expect)(Component).to.be.present();
    (0, _chai.expect)(Component).to.have.prop(
      'multiline',
  ...
  it('renders provided LabelComponent with title and labelComponentProps', function() {
    ...
    (0, _chai.expect)(labelComp).to.have.prop(
      'style',
      labelComponentProps.style
    );
  ...
  it('renders provided descriptionText', function() {
    ...
    var descriptionComp = wrapper.find(_Tooltip.default);
    (0, _chai.expect)(descriptionComp).to.have.length(1);
    (0, _chai.expect)(descriptionComp).to.have.prop('title', descriptionText);
  });
