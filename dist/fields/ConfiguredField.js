...
var _InfoOutlined = _interopRequireDefault(
  ...
  (function(_React$Component) {
    ...
    function RawConfiguredField() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(RawConfiguredField)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
    ...
    _createClass(RawConfiguredField, [
      {
        ...
        value: function render() {
          var _this$props = this.props,
            ...
            _this$props$labelComp = _this$props.labelComponentProps,
            labelComponentProps =
              _this$props$labelComp === void 0 ? {} : _this$props$labelComp,
          ...
          return _react.default.createElement(
            _FormControl.default,
            {
              ...
              className: (0, _classnames.default)(
                classes.root,
                _defineProperty({}, classes.withLabel, LabelComponent)
              )
            },
            LabelComponent &&
              title &&
            ...
            descriptionText && !(LabelComponent && title)
              ? _react.default.createElement(
                  ...
                  _react.default.createElement(
                    _IconButton.default,
                    null,
                    _react.default.createElement(_InfoOutlined.default, null)
                  )
                )
              : null,
            _react.default.createElement(
...
var _default = (0, _styles.withStyles)(_fieldStyles.default)(
  RawConfiguredField
);
