...
var _updateFormData = _interopRequireWildcard(
  require('./helpers/update-form-data')
);
  ...
  (function(_React$Component) {
    ...
    function Form() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'state', {
        ...
        errors: (0, _validation.default)(
          _this.props.schema,
          _this.props.formData
        ),
      ...
      _defineProperty(_assertThisInitialized(_this), 'onChange', function(
        ...
        return function(value) {
          ...
          var data = (0, _updateFormData.default)(
            _this.state.data,
            field,
            value
          );
      ...
      _defineProperty(_assertThisInitialized(_this), 'onMoveItemUp', function(
        path,
        idx
      ) {
        return function() {
          _this.setState(function(prevState) {
            return {
              data: (0, _updateFormData.moveListItem)(
                prevState.data,
                path,
                idx,
                -1
      ...
      _defineProperty(_assertThisInitialized(_this), 'onMoveItemDown', function(
        path,
        idx
      ) {
        return function() {
      ...
      _defineProperty(_assertThisInitialized(_this), 'onDeleteItem', function(
        path,
        idx
      ) {
        return function() {
          _this.setState(function(prevState) {
            return {
              data: (0, _updateFormData.removeListItem)(
                prevState.data,
                path,
                idx
              )
      ...
      _defineProperty(_assertThisInitialized(_this), 'onAddItem', function(
        ...
        return function() {
          _this.setState(function(prevState) {
            return {
              data: (0, _updateFormData.addListItem)(
                prevState.data,
                path,
                defaultValue || ''
              )
