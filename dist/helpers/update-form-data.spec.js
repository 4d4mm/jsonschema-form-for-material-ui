...
describe('updateFormData', function() {
  it('updates simple field', function() {
    ...
    (0, _chai.expect)(
      (0, _updateFormData.default)(initial, 'name', 'Harry')
  ...
  it('updates nested field', function() {
    ...
    (0, _chai.expect)(
      (0, _updateFormData.default)(initial, 'name.firstName', 'Harry')
    ).to.deep.equal(expected);
  });
  it('updates index field (object)', function() {
    ...
    (0, _chai.expect)(
      (0, _updateFormData.default)(initial, 'list[0].name', 'Harry')
    ).to.deep.equal(expected);
  });
  it('updates index field (simple)', function() {
    ...
    (0, _chai.expect)(
      (0, _updateFormData.default)(initial, 'list[0]', 'Harry')
    ).to.deep.equal(expected);
  });
  it('updates single field', function() {
    ...
    (0, _chai.expect)(
      (0, _updateFormData.default)(initial, '', 'updatedValue')
    ).to.deep.equal(expected);
  });
  it('removes array item', function() {
    ...
    (0, _chai.expect)(
      (0, _updateFormData.default)(initial, '', {
  ...
  describe('addListItem', function() {
    it('adds list item', function() {
      ...
      (0, _chai.expect)(
        (0, _updateFormData.addListItem)(initial, 'listItems', '3')
      ).to.deep.equal(expected);
    });
    it('adds list item to null list', function() {
      ...
      (0, _chai.expect)(
        (0, _updateFormData.addListItem)(initial, 'listItems', '1')
      ).to.deep.equal(expected);
    });
    it('adds list item - deep', function() {
      ...
      (0, _chai.expect)(
        (0, _updateFormData.addListItem)(initial, 'myprop.listItems', '3')
      ).to.deep.equal(expected);
    });
  });
  describe('removeListItem', function() {
    it('remove list item', function() {
      ...
      (0, _chai.expect)(
        (0, _updateFormData.removeListItem)(initial, 'listItems', 1)
      ).to.deep.equal(expected);
    });
    it('remove list item - deep', function() {
      ...
      (0, _chai.expect)(
        (0, _updateFormData.removeListItem)(initial, 'myprop.listItems', 1)
      ).to.deep.equal(expected);
    });
  });
  describe('moveListItem', function() {
    it('moves list item up', function() {
      ...
      (0, _chai.expect)(
        (0, _updateFormData.moveListItem)(initial, 'listItems', 1, -1)
      ).to.deep.equal(expected);
    });
    it('moves list item down', function() {
      ...
      (0, _chai.expect)(
        (0, _updateFormData.moveListItem)(initial, 'listItems', 0, 1)
      ).to.deep.equal(expected);
    });
  });
});
