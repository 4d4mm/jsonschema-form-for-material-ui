  ...
  (function(_React$Component) {
    ...
    function RawFormButtons() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(RawFormButtons)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
    ...
    _createClass(RawFormButtons, [
      {
        ...
        value: function render() {
          var _this$props = this.props,
            ...
            hasExternalOnSubmit = _this$props.hasExternalOnSubmit,
            _this$props$cancelTex = _this$props.cancelText,
            cancelText =
              _this$props$cancelTex === void 0
                ? 'Cancel'
                : _this$props$cancelTex,
            _this$props$submitTex = _this$props.submitText,
            submitText =
              _this$props$submitTex === void 0
                ? 'Submit'
                : _this$props$submitTex;
          var cancelProps = Object.assign(
            {
              variant: 'text',
              onClick: onCancel
            },
