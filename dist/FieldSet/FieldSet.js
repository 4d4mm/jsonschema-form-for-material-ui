...
var FieldSetContent = (0, _styles.withStyles)(
  _fieldSetStyles.default.fieldSetContent
)(RawFieldSetContent); // for unit testing
  ...
  (function(_React$Component) {
    ...
    function RawFieldSet() {
      ...
      _this = _possibleConstructorReturn(
        this,
        (_getPrototypeOf2 = _getPrototypeOf(RawFieldSet)).call.apply(
          _getPrototypeOf2,
          [this].concat(args)
        )
      );
...
var _default = (0, _styles.withStyles)(_fieldSetStyles.default.fieldSet)(
  RawFieldSet
);
