...
var _AddCircle = _interopRequireDefault(
  require('@material-ui/icons/AddCircle')
);
...
var _getDefaultValue = _interopRequireDefault(
  require('../helpers/get-default-value')
);

var _ReorderableFormField = _interopRequireDefault(
...
var RawFieldSetArray = function RawFieldSetArray(props) {
  ...
  return _react.default.createElement(
    ...
    !(0, _isArray.default)(schema.items) &&
      !schema.uniqueItems &&
            ...
            _extends(
              {
                ...
                data: d,
                onMoveItemUp:
                  onMoveItemUp && onMoveItemUp(path, startIdx + idx),
                onMoveItemDown:
                  onMoveItemDown && onMoveItemDown(path, startIdx + idx),
                onDeleteItem:
                  onDeleteItem && onDeleteItem(path, startIdx + idx),
          ...
          _react.default.createElement(
            _IconButton.default,
            {
              onClick:
                ...
                rest.onAddItem(
                  path,
                  (0, _getDefaultValue.default)(schema.items)
                )
            },
            _react.default.createElement(_AddCircle.default, null)
          )
        )
      ),
    (0, _isArray.default)(schema.items) &&
    ...
    !(0, _isArray.default)(schema.items) &&
      schema.uniqueItems &&
      schema.items.enum &&
      schema.items.enum.map(function(d) {
        return _react.default.createElement(
          _FormField.default,
          _extends(
            {
...
var _default = (0, _styles.withStyles)(_fieldSetStyles.default.fieldSetArray)(
  RawFieldSetArray
);
