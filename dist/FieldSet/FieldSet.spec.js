...
var _FieldSetObject = require('./FieldSetObject');

var _FieldSetArray = require('./FieldSetArray');

var _ReorderControls = _interopRequireWildcard(require('./ReorderControls'));

var _ReorderableFormField = _interopRequireWildcard(
  require('./ReorderableFormField')
);
...
describe('FieldSet', function() {
  describe('FieldSet - control', function() {
    it('mounts (control)', function() {
      ...
      var wrapper = (0, _enzyme.shallow)(
        _react.default.createElement(_FieldSet.RawFieldSet, {
          classes: classes,
          schema: schema,
          data: data
        })
  ...
  describe('FieldSetObject', function() {
    it('mounts with single field (control)', function() {
      ...
      var wrapper = (0, _enzyme.shallow)(
        _react.default.createElement(_FieldSetObject.RawFieldSetObject, {
          classes: classes,
          schema: schema,
          data: data
        })
  ...
  describe('FieldSetArray', function() {
    it('handles simple, orderable list of strings', function() {
      ...
      (0, _forEach.default)([0, 1], function(i) {
        return onMoveItemUp
          .withArgs(path, startIdx + i)
          .returns('moveUp'.concat(i));
      });
      (0, _forEach.default)([0, 1], function(i) {
        return onMoveItemDown
          .withArgs(path, startIdx + i)
          .returns('moveDown'.concat(i));
      });
      (0, _forEach.default)([0, 1], function(i) {
        return onDeleteItem
          .withArgs(path, startIdx + i)
          .returns('deleteItem'.concat(i));
      });
      var uiSchema = {
        items: {
          'ui:widget': 'textarea'
      ...
      var wrapper = (0, _enzyme.shallow)(
        _react.default.createElement(_FieldSetArray.RawFieldSetArray, {
          startIdx: startIdx,
          onAddItem: onAddItem,
      ...
      (0, _chai.expect)(wrapper).to.have.length(1);
      var ffComp = wrapper.find(_ReorderableFormField.default);
      (0, _chai.expect)(ffComp).to.have.length(2);
      (0, _forEach.default)([0, 1], function(i) {
        (0, _chai.expect)(ffComp.at(i)).to.have.prop(
          'path',
          'names['.concat(i + startIdx, ']')
        );
    ...
    it('handles simple, fixed list of strings', function() {
      ...
      (0, _chai.expect)(wrapper).to.have.length(1);
      var ffComp = wrapper.find(_FormField.default);
      var rffComp = wrapper.find(_ReorderableFormField.default);
      (0, _chai.expect)(ffComp).to.have.length(2);
      (0, _chai.expect)(rffComp).to.have.length(0);
      (0, _forEach.default)([0, 1], function(idx) {
        (0, _chai.expect)(ffComp.at(idx)).to.have.prop(
          'path',
          'names['.concat(idx, ']')
        );
    ...
    it('handles simple, fixed list of strings with additional items', function() {
      ...
      (0, _chai.expect)(fsArrayComp).to.have.prop(
        'uiSchema',
  ...
  describe('ReorderControls', function() {
    it('renders buttons with callbacks', function() {
      ...
      var wrapper = (0, _enzyme.shallow)(
        _react.default.createElement(_ReorderControls.RawReorderControls, {
          onMoveItemDown: onMoveItemDown,
          onDeleteItem: onDeleteItem,
          onMoveItemUp: onMoveItemUp,
          classes: classes
    ...
    it('ReorderableFormField - control', function() {
      ...
      var wrapper = (0, _enzyme.shallow)(
        _react.default.createElement(
          _ReorderableFormField.RawReorderableFormField,
          {
            path: path,
            first: first,
            last: last,
      ...
      var ffComp = wrapper.find(_FormField.default);
      (0, _chai.expect)(ffComp).to.have.length(1);
      var controls = wrapper.find(_ReorderControls.default);
